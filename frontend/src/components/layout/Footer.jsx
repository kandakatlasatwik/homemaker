...
const Footer = () => {
  ...
  return ( 
    <footer className={`${theme.footerBg} ${theme.footerText} py-6 fixed-footer mt-8 border-t ${theme.navBorder} transition-colors duration-300`}>
      <div className="container mx-auto px-4 flex flex-col sm:flex-row sm:justify-center sm:gap-30 items-center">
        <div className="mb-4 sm:mb-0">
          <h2 className={`text-lg font-semibold mb-2 ${theme.footerHover} hover:cursor-pointer transition-colors duration-300`}>Contact</h2>
          <p className={`${theme.footerHover} hover:cursor-pointer transition-colors duration-300`}>Email: info@homemakers.com</p>
          <p className={`${theme.footerHover} hover:cursor-pointer transition-colors duration-300`}>Phone: +91 98807 08008</p>
              <a
      ...
      <div className={`text-center mt-6 text-xs ${theme.textMuted}`}>
